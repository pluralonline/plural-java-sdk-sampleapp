            ...
            <main>
                <div class="py-5 text-center">
                    ...
                    <div class="text-center"> 
                        <p class="mb-0">EMI Calculation</p>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-12">
                        <form method="post" action="emiCalculator"class="needs-validation">
                            <div class="row g-3">
                                <div class="col-sm-6">
                            ...
                            <button class="w-100 my-4 btn btn-primary btn-lg" type="submit" >Calculate EMI</button>
                        </form>
                    </div>
                </div>
            </main>
